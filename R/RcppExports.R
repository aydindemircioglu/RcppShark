...
BSGDWrapperTrain <- function(X, Y, C, budget, gamma, epochs, budgetMaintenanceStrategy, useBias = TRUE, verbose = FALSE) {
    .Call('RcppShark_BSGDWrapperTrain', PACKAGE = 'RcppShark', X, Y, C, budget, gamma, epochs, budgetMaintenanceStrategy, useBias, verbose)
}
