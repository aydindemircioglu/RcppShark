...
public:
	...
	void solve(
		...
		{
			Rcpp::Rcout << std::endl;
			Rcpp::Rcout << "training time (seconds): " << timer.lastLap() << std::endl;
			Rcpp::Rcout << "number of epochs: " << epoch << std::endl;
			Rcpp::Rcout << "number of iterations: " << (ell * epoch) << std::endl;
			Rcpp::Rcout << "number of non-zero steps: " << steps << std::endl;
			Rcpp::Rcout << "dual accuracy: " << max_violation << std::endl;
			Rcpp::Rcout << "dual objective value: " << objective << std::endl;
			Rcpp::Rcout << "number of free support vectors: " << free_SV << std::endl;
			Rcpp::Rcout << "number of bounded support vectors: " << bounded_SV << std::endl;
		}
	}
